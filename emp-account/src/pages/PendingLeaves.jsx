...
const PendingLeaves = () => {
    ...
    useEffect(() => {
        ...
        if (employeeId) {
            axios.get(`http://localhost:8800/api/empLeave/pending/${employeeId}`)
                .then((response) => {
    ...
    return (
        <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
            ...
            <div class="flex items-center py-4 overflow-x-auto whitespace-nowrap">
                ...
                <a href="/pending-leaves" class="text-gray-600 dark:text-gray-200 hover:underline">
                    Pending Leaves
                </a>
                            ...
                            {pendingLeaves.map((leave) => (
                                <tr key={leave._id}>
                                    ...
                                    <td className="px-4 py-2">
                                        <span className={`rounded p-1 ${leave.status === 'Pending' ? 'bg-yellow-500 text-white' : 'bg-green-500 text-white'}`}>
                                            {leave.status}
                                        </span>
                                    </td>
                                    <td className="px-4 py-2">
